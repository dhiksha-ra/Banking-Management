            ...
            if(sender_account_number !=0 && receiver_account_number!=0){
                ...
                if(resultSet.next()){
                    ...
                    if(amount<=current_balance){
                        ...
                        PreparedStatement crediPreparedStatement=connection.prepareStatement(credit_query);
                        PreparedStatement debitPreparedStatement=connection.prepareStatement(debit_query);
                        crediPreparedStatement.setDouble(1,amount);
                        crediPreparedStatement.setLong(2,receiver_account_number);
                        debitPreparedStatement.setDouble(1, amount);
                        debitPreparedStatement.setLong(2, sender_account_number);
                        int rowsAffected1=debitPreparedStatement.executeUpdate();
                        int rowsAffected2=crediPreparedStatement.executeUpdate();
